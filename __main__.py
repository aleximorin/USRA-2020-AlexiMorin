...
if __name__ == '__main__':
    ...
    for glacier in results.index:
        ...
        # If not, burns it and use it
            ...
            try:
                burns_csv_to_raster(true_bed_path, shp_path, DEM_path, output_fn=raster_path, crop=crop)
        ...
        for model in models:
            ...
            try:
                error = compare_glacier_to_model(glacier, model, shp_path, bedrock_path,
        ...
        # Closes the raster for the next one in the loop
