...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{../inversion/hypsometric_curves/Job_hypso.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{../inversion/hypsometric_curves/Little kluane_hypso.png}
...
\DTLloaddb{rs}{../inversion/hypsometry_compared_r2_ez_view.csv}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.5]{../inversion/comparison_images/NorthGlacier_Farinotti_error.png}
